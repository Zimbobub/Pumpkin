...
#[derive(Clone)]
pub struct WorkstationInventory {
    pub width: u8,
    pub height: u8,
    pub items: Vec<Arc<Mutex<ItemStack>>>,
}

impl WorkstationInventory {
...
impl Inventory for WorkstationInventory {
    fn size(&self) -> usize {
        self.items.len()
    }
...
impl RecipeInputInventory for WorkstationInventory {
...
impl Clearable for WorkstationInventory {
