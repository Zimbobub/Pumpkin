...
use crate::workstation::workstation_screen_handler::WorkstationScreenHandler;
...
impl WorkstationScreenHandler<WorkstationInventory> for CraftingTableScreenHandler {}
